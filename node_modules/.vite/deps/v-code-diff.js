...
// node_modules/.pnpm/v-code-diff@1.12.1_vue@3.4.38_typescript@5.4.5_/node_modules/v-code-diff/dist/index.es.js
(function() {
  "use strict";
  try {
...
`, p), _ == -1 && (_ = d.length - 1);
    ...
    for (var t = [], i = /&/g, s = /</g, a = />/g, o = /\n/g, c = 0; c < n.length; c++) {
      var u = n[c][0], d = n[c][1], h = d.replace(i, "&amp;").replace(s, "&lt;").replace(a, "&gt;").replace(o, "&para;<br>");
      switch (u) {
        case f:
...
function sr(e) {
  const r = e.regex, l = new RegExp("[\\p{XID_Start}_]\\p{XID_Continue}*", "u"), f = [
    "and",
    "as",
    "assert",
    "async",
