...
const Gn = "</span>", Ye = (n) => !!n.scope, Kn = (n, { prefix: e }) => {
...
const nn = "[A-Za-z$_][0-9A-Za-z$_]*", Ut = [
  "as",
  // for exports
  "in",
  "of",
...
function Ht(n) {
  const e = n.regex, s = (y, { after: L }) => {
    const U = "</" + y[0].slice(1);
    return y.input.indexOf(U, L) !== -1;
  }, u = nn, h = {
    begin: "<>",
    end: "</>"
  }, t = /<[A-Za-z0-9\\._:-]+\s*\/>/, r = {
     ...
     */
    isTrulyOpeningTag: (y, L) => {
      const U = y[0].length + y.index, F = y.input[U];
      if (
      ...
      F === ">" && (s(y, { after: U }) || L.ignoreMatch());
      let W;
      const Y = y.input.substring(U);
      if (W = Y.match(/^\s*=/)) {
        L.ignoreMatch();
        return;
      }
  ...
  const A = [].concat(m, f.contains), S = A.concat([
  ...
  return {
    ...
    exports: { PARAMS_CONTAINS: S, CLASS_REFERENCE: R },
    illegal: /#(?![$_A-z])/,
    contains: [
      n.SHEBANG({
        label: "shebang",
...
function Wt(n) {
  ...
  }, f = "[0-9](_?[0-9])*", g = `(\\b(${f}))?\\.(${f})|\\b(${f})\\.`, d = `\\b|${u.join("|")}`, _ = {
    className: "number",
    relevance: 0,
    variants: [
...
function Zt(n) {
  ...
  function m(E, {
    ...
    const D = S;
    return A = A || [], E.map((N) => N.match(/\|\d+$/) || A.includes(N) ? N : D(N) ? `${N}|0` : N);
  }
  return {
    name: "SQL",
    case_insensitive: !0,
...
var T = /* @__PURE__ */ ((n) => (n.EQUAL = "equal", n.DELETE = "removed", n.ADD = "added", n.EMPTY = "empty", n))(T || {});
const J = "<code-diff-modified>", ee = "</code-diff-modified>", Yt = J.replace("<", "&lt;").replace(">", "&gt;"), Xt = ee.replace("<", "&lt;").replace(">", "&gt;");
function ge(n) {
  return n === void 0 ? T.EQUAL : n.added ? T.ADD : n.removed ? T.DELETE : T.EQUAL;
}
function Te(n, e, s = "word") {
  return typeof n == "undefined" ? e : typeof e == "undefined" ? n : (s === "char" ? $n : Pn)(n, e).filter((h) => ge(h) !== T.DELETE).map(
    (h) => ge(h) === T.ADD ? `${J}${h.value}${ee}` : h.value
  ).join("");
}
function yn(n, e) {
...
function V(n, e) {
  ...
  t.innerHTML = Z.highlight(h, { language: n }).value;
  let r = !1;
  const i = (a) => {
...
function jt(n, e, s = "plaintext", u = "word", h = !1, t = 10, r) {
  const i = () => ({ type: T.EMPTY }), a = (m, E, A) => ({ type: m, num: E, code: A }), o = yn(n, e), l = r ? new RegExp(r) : void 0;
  let c = 0, f = 0, g = !1;
  const d = [], _ = {
    changes: d,
    collector: [],
  ...
  for (let m = 0; m < o.length; m++) {
    ...
    const [E, A] = [o[m], o[m + 1]], [S, D] = [ge(E), ge(A)], N = E.value.replace(/\n$/, "").split(`
`);
    if (A === void 0) {
      for (const C of N) {
        let I = i(), $ = i();
        const B = V(s, C);
        S === T.EQUAL && (c++, f++, I = a(T.EQUAL, c, B), $ = a(T.EQUAL, f, B)), S === T.DELETE && (c++, I = a(T.DELETE, c, B), $ = i()), S === T.ADD && (f++, I = i(), $ = a(T.ADD, f, B)), d.push({ left: I, right: $ });
      }
      break;
    }
    if (S === T.EQUAL)
...
`);
    if (S === T.DELETE) {
      ...
      if (D === T.ADD) {
        ...
        for (let I = 0; I < C; I++) {
          I < E.count && c++, I < A.count && f++;
          const [$, B] = [N[I], R[I]], H = h || N.length === R.length, K = H ? Te(B, $, u) : $, te = H ? Te($, B, u) : B, le = l != null && l.test($) ? T.EQUAL : T.DELETE, b = l != null && l.test(B) ? T.EQUAL : T.ADD, y = I < E.count ? a(le, c, V(s, K)) : i(), L = I < A.count ? a(b, f, V(s, te)) : i();
          d.push({ left: y, right: L });
        }
      }
    }
    if (S === T.ADD)
  ...
  for (let m = 0; m < d.length; m++) {
    ...
    if (E.left.type === T.DELETE || E.right.type === T.ADD) {
      const [A, S] = [Math.max(m - t, 0), Math.min(m + t + 1, d.length)];
      for (let D = A; D < S; D++)
        d[D].fold = !1;
    }
  ...
  for (let m = 0; m < d.length; m++) {
    const E = d[m];
    if (E.fold === !1) {
      v.length && (v[0].hideIndex = _.collector.length, _.collector.push({
        lines: v,
        fold: !0
      }), v = []), p.push(E);
      continue;
    }
    E.hide = !0, v.push(E), p.push(E);
  }
  return v.length && (v[0].hideIndex = _.collector.length, _.collector.push({
    lines: v,
    fold: !0
  }), v = []), _.changes = p, _;
}
function qt(n, e, s = "plaintext", u = "word", h = !1, t = 10, r) {
  ...
  for (let p = 0; p < i.length; p++) {
    ...
    const [v, m] = [i[p], i[p + 1]], [E, A] = [ge(v), ge(m)], S = v.value.replace(/\n$/, "").split(`
`);
    if (m === void 0) {
      for (const N of S) {
    ...
    const D = m.value.replace(/\n$/, "").split(`
`);
    if (E === T.DELETE)
      if (A === T.ADD && (S.length === D.length || h)) {
        for (let N = 0; N < S.length; N++) {
          const R = S[N], C = D[N];
          o++;
          const I = V(s, Te(C, R, u));
          f.push({
            type: a != null && a.test(R) ? T.EQUAL : T.DELETE,
            code: I,
            delNum: o
          });
        }
        for (let N = 0; N < D.length; N++) {
          const R = S[N], C = D[N];
          l++;
          const I = V(s, Te(R, C, u));
          f.push({
            type: a != null && a.test(C) ? T.EQUAL : T.ADD,
            code: I,
            addNum: l
          });
        }
  ...
  for (let p = 0; p < f.length; p++) {
    ...
    if (v.type === T.DELETE || v.type === T.ADD) {
      const [m, E] = [Math.max(p - t, 0), Math.min(p + t + 1, f.length)];
      for (let A = m; A < E; A++)
        f[A].fold = !1;
    }
  ...
  for (let p = 0; p < f.length; p++) {
    const v = f[p];
    if (v.fold === !1) {
      _.length && (_[0].hideIndex = g.collector.length, g.collector.push({
        lines: _,
        fold: !0
      }), _ = []), d.push(v);
      continue;
    }
    v.type === "equal" && (v.hide = !0, _.push(v)), d.push(v);
  }
  return _.length && (_[0].hideIndex = g.collector.length, g.collector.push({
    lines: _,
    fold: !0
  }), _ = []), g.changes = d, g;
}
const Jt = /* @__PURE__ */ be({
  __name: "UnifiedLine",
  props: {
    line: null
  },
  ...
  setup(n, { emit: e }) {
    function s(u) {
      return u === T.DELETE ? "-" : u === T.ADD ? "+" : "";
    }
    return { __sfc: !0, emit: e, getCodeMarker: s, DiffType: T };
  }
});
function oe(n, e, s, u, h, t, r, i) {
...
const rr = tr.exports, ir = /* @__PURE__ */ be({
...
const lr = or.exports, cr = /* @__PURE__ */ be({
  __name: "SplitLine",
  props: {
    splitLine: null
  },
  ...
  setup(n, { emit: e }) {
    ...
    return { __sfc: !0, emit: e, getCodeMarker: s, onSplitLineMousedown: u, DiffType: T };
  }
});
var ur = function() {
  var e = this, s = e._self._c, u = e._self._setupProxy;
...
const hr = gr.exports, dr = /* @__PURE__ */ be({
  __name: "SplitViewer",
  props: {
    diffChange: null
  },
...
const Cr = /* @__PURE__ */ be({
  ...
  emits: ["diff"],
  setup(n, { emit: e }) {
    const s = n, u = he(() => s.outputFormat === "line-by-line"), h = he(() => {
      let g = s.oldString || "";
...
`) : g, g;
    ...
    ), i = We(r.value), a = he(() => i.value.stat.additionsNum === 0 && i.value.stat.deletionsNum === 0), o = We(-1);
    function l() {
