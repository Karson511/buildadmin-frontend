        ...
        l('div', null, [
            ...
            _(
                v(
                    ...
                    [e.enableCustomError ? (i(), l('div', E, [y(s.$slots, 'customError', {}, void 0, !0)])) : (i(), l('span', j, '加载失败'))],
                    4
                ),
                [[g, !t.isLoaded]]
            ),
            C(
                ...
                },
                {
                    default: S(() => [
                        ...
                        e.customPreview ? (i(), l('div', F, [y(s.$slots, 'previewVideo', {}, void 0, !0)])) : f('v-if', !0),
                    ]),
                    _: 3,
                },
                8,
...
const W = N(B, [
    ['render', U],
    ['__scopeId', 'data-v-c13bd0c3'],
    ['__file', '/Users/hukaisheng/data/wwwroot/personal/javaScript/build-frontend/src/views/backend/shop/userProfileLog/video.vue'],
])
export { W as default }
