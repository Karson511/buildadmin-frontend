...
const He = $n(hr),
    ...
    de = {
        path: F,
        name: 'admin',
        component: () => _(() => import('./index-re230GT6.js'), __vite__mapDeps([0, 1, 2, 3, 4, 5, 6, 7, 8]), import.meta.url),
        redirect: F + '/loading',
        ...
        children: [
            {
                ...
                component: () => _(() => import('./loading-8UMWyr3R.js'), __vite__mapDeps([9, 1, 2]), import.meta.url),
                meta: { title: 'pagesTitle.loading' },
            },
        ],
    },
    _r = Object.freeze(Object.defineProperty({ __proto__: null, adminBaseRoutePath: F, default: de }, Symbol.toStringTag, { value: 'Module' })),
    ne = '/user',
    yr = {
        path: ne,
        name: 'user',
        component: () => _(() => import('./user-D9MYYLrR.js'), __vite__mapDeps([10, 1, 11, 2, 6, 3]), import.meta.url),
        redirect: ne + '/loading',
    ...
    Ht = [
        {
            path: '/',
            name: '/',
            component: () => _(() => import('./index-DeEcM0CD.js'), __vite__mapDeps([12, 1, 11, 2, 6, 3]), import.meta.url),
            meta: { title: ue('home') },
        },
        {
            path: F + '/login',
            name: 'adminLogin',
            component: () => _(() => import('./login-DBSatFNj.js'), __vite__mapDeps([13, 1, 7, 14, 15, 6, 16]), import.meta.url),
            meta: { title: ue('adminLogin') },
        },
        {
            path: ne + '/login',
            name: 'userLogin',
            component: () => _(() => import('./login-sus1UsYt.js'), __vite__mapDeps([17, 1, 11, 2, 6, 3, 14, 15]), import.meta.url),
        ...
        { path: '/:path(.*)*', redirect: '/404' },
        {
            path: '/404',
            name: 'notFound',
            component: () => _(() => import('./404-GnenWeJ2.js'), __vite__mapDeps([18, 1]), import.meta.url),
        ...
        { path: ne + ':path(.*)*', redirect: (e) => ({ name: 'userMainLoading', params: { to: JSON.stringify({ path: e.path, query: e.query }) } }) },
        {
            path: '/401',
            name: 'noPower',
            component: () => _(() => import('./401-BRuOVPQa.js'), __vite__mapDeps([19, 1]), import.meta.url),
            meta: { title: ue('noPower') },
        },
    ],
    Ie = Object.assign({ './static/adminBase.ts': _r, './static/memberCenterBase.ts': wr })
for (const e in Ie) Ie[e].default && Ht.push(Ie[e].default)
const Wt = {
        show: () => {
    ...
    gt = {
        ...
        [F + '/moduleStore']: ['./backend/${lang}/module.ts'],
        [F + '/user/rule']: ['./backend/${lang}/auth/rule.ts'],
        [F + '/user/audit']: ['./backend/${lang}/user/audit.ts'],
        [F + '/user/scoreLog']: ['./backend/${lang}/user/moneyLog.ts'],
        [F + '/crud/crud']: ['./backend/${lang}/crud/log.ts', './backend/${lang}/crud/state.ts'],
        [F + '/posts/audit']: ['./backend/${lang}/posts/postAuditDrafts.ts'],
        [F + '/posts/posts']: ['./backend/${lang}/posts/posts.ts'],
    },
    vr = {
        noPowerTip:
    ...
    Cr = Object.freeze(Object.defineProperty({ __proto__: null, default: Ir }, Symbol.toStringTag, { value: 'Module' })),
    Nr = {
        'problems tip':
    ...
    n == 'zh-cn'
        ? (window.loadLangHandle = {
              ...Object.assign({
                  ...
                  './backend/zh-cn/membership/configs.ts': () => _(() => import('./configs-BR8VHP55.js'), [], import.meta.url),
                  ...
                  './backend/zh-cn/posts/postAuditDrafts.ts': () => _(() => import('./postAuditDrafts-BUK9K8am.js'), [], import.meta.url),
                  './backend/zh-cn/posts/posts.ts': () => _(() => import('./posts-BgqieCJD.js'), [], import.meta.url),
                  ...
                  './backend/zh-cn/user/audit.ts': () => _(() => import('./audit-CKybTNp6.js'), [], import.meta.url),
        ...
        : (window.loadLangHandle = {
              ...Object.assign({
                  ...
                  './backend/en/membership/configs.ts': () => _(() => import('./configs-fYiCUPc0.js'), [], import.meta.url),
                  './backend/en/module.ts': () => _(() => import('./module-B_X4aWZH.js'), [], import.meta.url),
                  './backend/en/posts/postAuditDrafts.ts': () => _(() => import('./postAuditDrafts-Bhm7EzIH.js'), [], import.meta.url),
                  './backend/en/posts/posts.ts': () => _(() => import('./posts-DasW3dBn.js'), [], import.meta.url),
                  ...
                  './backend/en/user/audit.ts': () => _(() => import('./audit-dDKHdBIt.js'), [], import.meta.url),
...
const B = Wn({ history: Jn(), routes: Ht })
B.beforeEach((e, t, n) => {
    ...
    if ((console.log('to.fullPath:', e.fullPath), $(e.fullPath))) {
        ...
        const i = e.path.slice(e.path.indexOf(F) + F.length)
...
function Kt(e) {
    return (
        e.forEach((t) => {
            var n
            ;((n = t.meta) == null ? void 0 : n.menu_type) == 'iframe' && (t.path = F + '/iframe/' + encodeURIComponent(t.path)),
...
function Ti(e = !1, t = {}) {
    ...
    function a(i) {
        ...
        {
            const c = C(n)
            return (s.value = s.value === c ? C(r) : c), s.value
        }
    }
    return o ? a : [s, a]
}
...
function vo(e, t = {}) {
    ...
    const s = U(!1),
        ...
        c = sr(() => {
            r.value &&
                (i(), (o = n.matchMedia(C(e))), 'addEventListener' in o ? o.addEventListener('change', a) : o.addListener(a), (s.value = o.matches))
        })
    return (
        Oe(() => {
            c(), i(), (o = void 0)
...
function Lo(e = null, t = {}) {
    ...
    function m(h) {
        ...
        return typeof g == 'function' ? g(h) : C(g).replace(/%s/g, h)
    }
    return (
        K(
            c,
...
function Po(e, t, n, r = {}) {
    ...
    const a = C(t),
        ...
        c = Fe(a),
        u = Fe(i),
        m = (o = C(r.duration)) != null ? o : 1e3,
        h = Date.now(),
        g = Date.now() + m,
        w = typeof r.transition == 'function' ? r.transition : (s = C(r.transition)) != null ? s : po,
...
function Oi(e, t = {}) {
    ...
    const r = () => {
            const s = C(e)
            return typeof s == 'number' ? s : s.map(C)
        },
        o = U(r())
    return (
        K(
            ...
            async (s) => {
                ...
                const c = ++n
                if ((t.delay && (await mo(C(t.delay))), c !== n)) return
                const u = Array.isArray(s) ? s.map(C) : C(s)
...
let z = class {
    ...
    set(t, n, r) {
        ...
        else if (p.isString(t) && (t = t.trim()) && !Ns(t)) a(Is(t), n)
...
ut.transitional = function (t, n, r) {
    ...
    return (s, a, i) => {
        ...
        return (
            n && !Ct[a] && ((Ct[a] = !0), console.warn(o(a, ' has been deprecated since v' + n + ' and will be removed in the near future'))),
            t ? t(s, a, i) : !0
        )
    }
}
...
I.mergeConfig = ee
I.AxiosHeaders = z
I.formToJSON = (e) => En(p.isHTMLForm(e) ? new FormData(e) : e)
I.getAdapter = An.getAdapter
I.HttpStatusCode = Ze
I.default = I
const {
        Axios: Ai,
    ...
    W = '/api/account/'
function Hi(e, t = {}) {
    return x({ url: In + 'checkIn', data: t, method: e })
}
function Wi() {
...
function sa() {
    const e = ct()
    return x({ url: In + 'logout', method: 'POST', data: { refreshToken: e.getToken('refresh') } })
}
function eu(e) {
...
function x(e, t = {}, n = {}) {
    ...
    const a = I.create({ baseURL: re(), timeout: 1e3 * 10, headers: { 'think-lang': r.lang.defaultLang, server: !0 }, responseType: 'json' })
    return (
                ...
                if ((Ue(i.config), t.loading && Nt(t), i.config.responseType == 'json'))
                    if (i.data && i.data.code !== 1) {
                                ...
                                : ((window.tokenRefreshing = !0),
                                  Sa()
                                      ...
                                      .catch((c) =>
                                          $()
                                              ? (o.removeToken(),
                                                B.currentRoute.value.name != 'adminLogin'
                                                    ? (B.push({ name: 'adminLogin' }), Promise.reject(c))
                                                    : ((i.headers.batoken = ''),
                                                      window.requests.forEach((u) => u('', 'admin-refresh')),
                                                      (window.requests = []),
                                                      a(i.config)))
                                              : (s.removeToken(),
                                                B.currentRoute.value.name != 'userLogin'
                                                    ? (B.push({ name: 'userLogin' }), Promise.reject(c))
                        ...
                        if (
                            ...
                            i.data.code == 302 && B.push({ path: i.data.data.routePath ?? '', name: i.data.data.routeName ?? '' }),
                            i.data.code == 303)
                        ) {
                            const c = $()
                            let u = c ? de.path : ne
                            i.data.data.type == 'need login' && (c ? o.removeToken() : s.removeToken(), (u += '/login')), B.push({ path: u })
                        }
...
function Oa(e) {
    if (I.isCancel(e)) return console.error(O.global.t('axios.Automatic cancellation due to duplicate request:') + e.message)
    let t = ''
    if (e && e.response)
...
function xa() {
    H(() => {
        if (typeof B.currentRoute.value.meta.title != 'string') return
        const e = O.global.te(B.currentRoute.value.meta.title) ? O.global.t(B.currentRoute.value.meta.title) : B.currentRoute.value.meta.title,
            t = Lo(),
            n = Se()
...
const Ca = (e, t = '') => {
    ...
    Fn = () => {
        let e = B.currentRoute.value.path
        return (
...
function ai(e) {
    e.directive('auth', {
        mounted(t, n) {
            if (!n.value) return !1
            Ia(n.value) || t.parentNode.removeChild(t)
        },
    })
}
function ii(e) {
...
async function di() {
    const e = mr(Wa)
    e.use(Vn), console.log('main.ts'), await Xr(e), e.use(B), e.use(pr), si(e), La(e), e.mount('#app'), (e.config.globalProperties.eventBus = Ja())
}
di()
export {
    Su as $,
