...
import y from './popupForm-Bi1vxhQm.js'
import { g as E } from './group-DpWBpRI2.js'
import { a4 as w, y as R, _ as I } from './index-BinDduO1.js'
import { b as A, d as S, a as N, T as q } from './index-1fitz5rj.js'
        ...
        setup(_, { expose: m }) {
            ...
            const { t } = k.useI18n(),
                ...
                e = new A(
                    ...
                    {
                        onSubmit: ({ formEl: r, operate: s, items: n }) => {
                            let p = () => {
                ...
                o = () => {
                    E().then((r) => {
                        if (((e.form.extend.menuRules = r.data.list), e.form.items.rules && e.form.items.rules.length))
            ...
            C('baTable', e),
                x(() => {
                    ;(e.table.ref = a.value), e.mount(), e.getIndex()
                })
            const c = { t, tableRef: a, formRef: u, baTable: e, menuRuleTreeUpdate: o, PopupForm: y, TableHeader: q, Table: N }
            return Object.defineProperty(c, '__isScriptSetup', { enumerable: !1, value: !0 }), c
        },
    }),
    G = { class: 'default-main ba-table-box' }
function K(_, m, t, a, u, e) {
    const o = T('el-alert')
    return (
        h(),
        v('div', G, [
            a.baTable.table.remark
                ? (h(), F(o, { key: 0, class: 'ba-table-alert', title: a.baTable.table.remark, type: 'info', 'show-icon': '' }, null, 8, ['title']))
                : l('v-if', !0),
            l(' 表格顶部菜单 '),
            d(
                a.TableHeader,
                {
                    ...
                    'quick-search-placeholder': a.t('Quick search placeholder', { fields: a.t('user.group.GroupName') }),
                },
                null,
                8,
            ...
            d(a.Table, { ref: 'tableRef' }, null, 512),
            l(' 表单 '),
            d(a.PopupForm, { ref: 'formRef' }, null, 512),
        ])
    )
}
const z = I(B, [
    ['render', K],
    ['__file', '/Users/hukaisheng/data/wwwroot/personal/javaScript/build-frontend/src/views/backend/shop/chat/index.vue'],
])
export { z as default }
