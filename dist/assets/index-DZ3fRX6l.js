...
import { b as N, T as P, a as U } from './index-1fitz5rj.js'
import { u as D, a as q, P as R } from './popupForm-URoZQ4i2.js'
import { a4 as z, _ as B } from './index-BinDduO1.js'
                ...
                a = new N(
                    new z(D),
                    {
                        column: [
                            ...
                            { label: r('user.moneyLog.Change balance'), prop: 'money', align: 'center', operator: 'RANGE', sortable: 'custom' },
    ...
    return (
        ...
        F('div', j, [
            e.baTable.table.remark
                ? (c(), b(n, { key: 0, class: 'ba-table-alert', title: e.baTable.table.remark, type: 'info', 'show-icon': '' }, null, 8, ['title']))
                : s('v-if', !0),
            s(' 表格顶部菜单 '),
            i(
                e.TableHeader,
                                              ...
                                              S(
                                                  ...
                                                  A(
                                                      e.state.userInfo.username +
                                                          ...
                                                          e.state.userInfo.id +
                                                          ') ' +
                                                          e.t('user.moneyLog.balance') +
                                                          ':' +
                                                          e.state.userInfo.money
                                                  ),
                                                  1
                                              ),
                                          ]),
...
const Y = B(G, [
    ['render', K],
    ['__file', '/Users/hukaisheng/data/wwwroot/personal/javaScript/build-frontend/src/views/backend/user/moneyLog/index.vue'],
])
export { Y as default }
