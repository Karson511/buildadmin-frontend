...
const He = $n(hr),
    ...
    de = {
        path: B,
        name: 'admin',
        component: () => _(() => import('./index-jFTHcjRS.js'), __vite__mapDeps([0, 1, 2, 3, 4, 5, 6, 7, 8]), import.meta.url),
        redirect: B + '/loading',
        ...
        children: [
            {
                ...
                component: () => _(() => import('./loading-Bpzc_Jcq.js'), __vite__mapDeps([9, 1, 2]), import.meta.url),
    ...
    yr = {
        path: ne,
        name: 'user',
        component: () => _(() => import('./user-qUkqMFuW.js'), __vite__mapDeps([10, 1, 11, 2, 6, 3]), import.meta.url),
        redirect: ne + '/loading',
    ...
    Ht = [
        {
            path: '/',
            name: '/',
            component: () => _(() => import('./index-BLYYvcPV.js'), __vite__mapDeps([12, 1, 11, 2, 6, 3]), import.meta.url),
            meta: { title: ue('home') },
        },
        {
            path: B + '/login',
            name: 'adminLogin',
            component: () => _(() => import('./login-CG0xfBaE.js'), __vite__mapDeps([13, 1, 7, 14, 15, 6, 16]), import.meta.url),
            meta: { title: ue('adminLogin') },
        },
        {
            path: ne + '/login',
            name: 'userLogin',
            component: () => _(() => import('./login-aUhDEGCN.js'), __vite__mapDeps([17, 1, 11, 2, 6, 3, 14, 15]), import.meta.url),
        ...
        { path: '/:path(.*)*', redirect: '/404' },
        {
            path: '/404',
            name: 'notFound',
            component: () => _(() => import('./404-CM6TKy6J.js'), __vite__mapDeps([18, 1]), import.meta.url),
        ...
        { path: ne + ':path(.*)*', redirect: (e) => ({ name: 'userMainLoading', params: { to: JSON.stringify({ path: e.path, query: e.query }) } }) },
        {
            path: '/401',
            name: 'noPower',
            component: () => _(() => import('./401-BWjgao8v.js'), __vite__mapDeps([19, 1]), import.meta.url),
